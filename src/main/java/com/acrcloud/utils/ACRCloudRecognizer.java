...
public class ACRCloudRecognizer {
    ...
    public static void main(String[] args) {
        ...
        config.put("access_key", "8e59a4a51aca4cc1d865868eb8bea8cd");
        config.put("access_secret", "KWfTDefYGipu8lfjUryCDneZSuBsod6zHv4ns5SL");
        ...
        //ACRCloudExtrTool.setDebug();
//        byte[] fp = ACRCloudExtrTool.createFingerprintByFile("C:/Users/ik/Downloads/Мейрамбек Беспаев Кус Канат Гумыр.mp3", 0, 0, true);
//        System.out.println(re.encodeBase64(fp));
        //byte[] fp = ACRCloudExtrTool.decodeAudioByFile(args[0], 200, 0);
        //System.out.println(fp.length);

        File file = new File("C:\\Users\\ik\\Downloads/Мейрамбек Беспаев Кус Канат Гумыр.mp3");
